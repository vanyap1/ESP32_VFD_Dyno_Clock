...
<body>
  <div class="main-container">
    ...
    <div class="terminal-section">
      ...
      <div style="display: flex; gap: 30px; align-items: flex-start; justify-content: center; flex-wrap: wrap;">
        ...
        <div style="flex: 1 1 auto; max-width: 800px;">
          ...
          <div id="asciiTable" style="display: grid; grid-template-columns: repeat(16, 1fr); gap: 3px;"></div>
        </div>
      </div>
    </div>
    ...
    <div class="terminal-section">
      ...
      <div id="bitContainer" style="display: flex; flex-wrap: wrap; gap: 5px; justify-content: center;"></div>
...
<script>
        ...
        bitArray = new Array(24).fill(0);
        segmentMapping = {};
        currentEditingChar = null;
        charPatterns = {};
        currentDisplayType = '7seg';
        ...
        async function loadCharacterTable() {
            try {
                ...
                for (let i = 0; i < 96; i++) {
                    ...
                    const pattern = dataView.getUint32(offset, true);
                    const asciiCode = 32 + i;
        ...
        function updateSegmentsFromPattern(pattern) {
            ...
            const svgToArrMap7seg = [0, 5, 2, 6, 7, 4, 3, 1];
      ...
      <div class="setup-group">
        ...
        <table class="sensor-table">
          ...
          <tr>
            ...
            <td class="sensor-description">
              <span class="variable-hint">Variables: *EUR*, *USD*, *EURdDIVIDER,DECIMALS*, *USDdDIVIDER,DECIMALS*, *BTCf*, *BTCs*, *BTCdDIVIDER,DECIMALS*<br>Exchange rates in your local currency<br>Dynamic divider formats work for EUR, USD and BTC</span>
            </td>
          </tr>
        </table>
